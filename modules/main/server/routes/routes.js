...
exports.addRsvp = function(req, res) {
  ...
  var mailOptions = {
    ...
    html: '<div style="text-align: center; color: #333; font-family: sans-serif;"><div style="padding: 20px;text-align:left; background: lightblue;"><h1 style="color: #ffffff; font-weight: 100;margin-top: 0; margin-left: 0;">Mackenzie and Jonathan\'s Wedding</h1></div>'+
  ...
  '<div style="background: lightblue; padding: 20px; height: 20px;margin-top: 10px;"><p style="display:none;"> some text</p></div></div>' // html body
  }
