...
exports.addRsvp = function(req, res) {
  ...
  var mailOptions = {
    ...
    '<img style="margin-top: 10px; border-radius: 5px;" src="http://pyke.us/images/email/rsvp-header.jpg"/><div style="padding-left: 20px;padding-right:20px; text-align:left;"><p>'+req.body.uname+',</p><p>We look forward to seeing you on our wedding day! We will be saving '+seatSent+' for you, and can\'t wait to celebrate together.<br>'+songSentence+'<br><br>Please find the venue address and directions by clicking on the map below. Remember to leave plenty of extra time for the ferry crossing as it is often backed up on summer weekends. </p></div>'+
