...
exports.addRsvp = function(req, res) {
  ...
  var mailOptions = {
    ...
    html: '<div style="text-align: center; color: #333; font-family: sans-serif;"><div style="padding: 20px;text-align:left; background: lightblue;"><h1 style="color: #ffffff; font-weight: 100;margin-top: 0; margin-left: 0;">Jonathan and Mackenzie\'s Wedding</h1></div></div>
